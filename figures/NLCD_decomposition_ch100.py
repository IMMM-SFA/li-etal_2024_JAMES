...
variables_to_read = ["TC_URB", "TB_URB", "TG_URB", "TA_URB", "ALPHAC_URB2D", "ALPHAB_URB2D", 
                     "ALPHAG_URB2D", "UTYPE_URB", "LU_INDEX", "T", "HFX"]
...
AH_values = {
    "NLCD/outputs_no_AH_ch100": 0, 
    "NLCD/outputs_AH_option2_ch100": 10       
}
...
for utype in utypes:
    ...
    for folder, ds in datasets.items():
        ...
        print(overall_spatial_avg_diff)
...
fig.savefig("figures/NLCD_decomposition_ch100.png", dpi=300)
...
fig.savefig("figures/Conductances_ch100.png", dpi=300)
