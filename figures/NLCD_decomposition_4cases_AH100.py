...
for i, (case, ax) in enumerate(zip(datasets.keys(), axes)):
    ...
    if AH_option_to_study == 2 : 
        ...
        ax.set_ylim([-0.005, 0.02])  # Adjust as needed based on your data
    elif AH_option_to_study == 3 :
        ax.set_ylim([-0.02, 0.08])  # Adjust as needed based on your data
        
    ax.set_ylabel('dT$_{C}$/dQ$_{AH}$ (K/(W m$^{-2}$))', fontsize=axis_label_font_size)
...
if AH_option_to_study == 2 : 
    fig.savefig("figures/NLCD_decomposition_all_4cases_AH100_AH_option_2.png", dpi=300)
elif AH_option_to_study == 5 :
    fig.savefig("figures/NLCD_decomposition_all_4cases_AH100_AH_option_5.png", dpi=300)
elif AH_option_to_study == 3 :
    fig.savefig("figures/NLCD_decomposition_all_4cases_AH100_AH_option_3.png", dpi=300)
