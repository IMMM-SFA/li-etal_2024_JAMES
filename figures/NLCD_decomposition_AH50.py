...
folder_paths = [
    ...
    "T2_test/T2_test_AH_option4_50", 
    "T2_test/T2_test_AH_option3_50",    
    "T2_test/T2_test_AH_option2_50"
]
...
AH_values = {
    ...
    "T2_test/T2_test_AH_option4_50": 0,   
    "T2_test/T2_test_AH_option3_50": 0,       
    "T2_test/T2_test_AH_option2_50": AH_value
}

method_map = {
    'T2_test/T2_test_AH_option4_50': 'method 1',
    'T2_test/T2_test_AH_option3_50': 'method 2',
    'T2_test/T2_test_AH_option2_50': 'method 3',
    # Add more if needed
}
...
titles = ["(d) method 1", "(e) method 2", "(f) method 3"]
...
fig.savefig("figures/NLCD_decomposition_all_AH50.png", dpi=300)
